...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250731120123_AddCreatedTimeColumnOfSaleTable")]
    partial class AddCreatedTimeColumnOfSaleTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Products.ProductUnit", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_unit");

                    b.ToTable("product_unit", "public");
                });
            ...
            modelBuilder.Entity("Domain.Products.ProductDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Products.Product", "Product")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_product_detail_product_product_id");
                    ...
                    b.OwnsOne("Domain.Common.Name", "Name", b1 =>
                        {
                            ...
                            b1.HasIndex("Normalized")
                                .HasDatabaseName("ix_product_tag_normalized_name");

                            b1.ToTable("product_tag", "public");

                            b1.WithOwner()
                                .HasForeignKey("ProductTagId")
                                .HasConstraintName("fk_product_tag_product_tag_id");
                        });
                    ...
                    b.OwnsOne("Domain.Common.Name", "Name", b1 =>
                        {
                            ...
                            b1.HasIndex("Normalized")
                                .HasDatabaseName("ix_product_unit_normalized_name");

                            b1.ToTable("product_unit", "public");

                            b1.WithOwner()
                                .HasForeignKey("ProductUnitId")
                                .HasConstraintName("fk_product_unit_product_unit_id");
                        });
            ...
            modelBuilder.Entity("Domain.Purchases.PurchaseProductEntry", b =>
                {
                    ...
                    b.HasOne("Domain.Products.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_purchase_product_entry_product_product_id");
                    ...
                    b.HasOne("Domain.Purchases.Purchase", "Purchase")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_purchase_product_entry_purchase_purchase_id");
            ...
            modelBuilder.Entity("Domain.Sales.SaleProductEntry", b =>
                {
                    ...
                    b.HasOne("Domain.Products.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_sale_product_entry_product_product_id");
                    ...
                    b.HasOne("Domain.Sales.Sale", "Sale")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sale_product_entry_sale_sale_id");
